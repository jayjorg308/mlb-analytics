...
-- AddForeignKey
ALTER TABLE "Game" ADD CONSTRAINT "Game_startingPitcherHomeId_fkey" FOREIGN KEY ("startingPitcherHomeId") REFERENCES "Player"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Game" ADD CONSTRAINT "Game_startingPitcherAwayId_fkey" FOREIGN KEY ("startingPitcherAwayId") REFERENCES "Player"("id") ON DELETE SET NULL ON UPDATE CASCADE;
